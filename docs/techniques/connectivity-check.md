...
La verificacion de conectividad confirma que el host responde y da pistas iniciales como TTL, latencia o filtrado ICMP. Es una fase de orientacion, no una prueba de explotabilidad.
