...
La enumeracion de puertos identifica servicios escuchando, versiones y scripts relevantes. Es la base para decidir si buscar CVEs, probar configuraciones o pasar a enumeracion especifica por servicio.
