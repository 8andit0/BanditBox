...
grep aparece en BanditBox como herramienta de apoyo para la fase de privilege-escalation. La pagina agrupa maquinas y tecnicas donde la herramienta tiene evidencia de uso o mencion relevante.
